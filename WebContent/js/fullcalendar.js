	...
	*/
	DragListener.mixin({
		...
		initAutoScroll : function() {
			...
			this.isAutoScroll = this.options.scroll &&
				scrollEl &&
				!scrollEl.is(window) &&
	...
	*/
	...
	var Grid = FC.Grid = Class.extend(ListenerMixin, {
		...
		processRangeOptions : function() {
			...
			this.eventTimeFormat = view.opt('eventTimeFormat') ||
	...
	*/
	...
	Calendar.mixin({
		...
		buildViewSpecButtonText : function(spec, requestedViewType) {
			...
			spec.buttonTextOverride = queryButtonText(this.dynamicOverrides) ||
			queryButtonText(this.overrides) || // constructor-specified buttonText lookup hash takes precedence
			spec.overrides.buttonText; // `buttonText` for view-specific options is a string

			// highest to lowest priority. mirrors buildViewSpecOptions
			spec.buttonTextDefault = queryButtonText(this.localeDefaults) ||
	...
	Calendar.mixin({
		...
		renderView : function(viewType, forcedScroll) {
			...
			if (!this.view && viewType) {
				this.view = this.viewsByType[viewType] ||
