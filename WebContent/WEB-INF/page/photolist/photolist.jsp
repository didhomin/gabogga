...
$('.thumbnail').on('mouseover', function() {
  ...
  infowindow = new daum.maps.InfoWindow({
      ...
      content : //'<div style="padding:5px;">' + title + '<br><a href="naver.com/' + x + ',' + y + '">지도보기</a></div>'
         '<center><div style="padding:5px;"><img src="${root}/upload/' + ghpic + '" width="250px"><a class="anchorjs-link" href="${root }/house/reservation.gbg?guesthouseId=' + ghId + '"><h4>' + title + '</h4></a><a href="http://map.daum.net/link/map/' + x + ',' + y + '" style="color:blue" target="_blank">큰지도보기</a> <a href="http://map.daum.net/link/to/'+title +',' + x + ',' + y + '" style="color:blue" target="_blank">길찾기</a></div></center>'
         });
...
$(markers).each(function(i, v){
	daum.maps.event.addListener(v, 'click', function() {
		$('.thumbnail').eq(i).mouseover();
	});
});
