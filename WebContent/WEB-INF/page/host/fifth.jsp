			...
			<div class="row" style="padding-bottom: 50px;">
				<div class="col-sm-8 col-sm-push-1" style="padding-top: 30px;">
					...
					<form name="hostform" method="post" enctype="multipart/form-data">
						...
						<input type="hidden" id="roomId" name="roomId" value="${host5.roomId}">
					...
					<div class="row">
						<div class="col-sm-8">
							...
							<c:choose>
							<c:when test="${host5.roomPay != null }">
							<input type="text" name="roomPay" id="roomPay"  class="form-control" placeholder="￦/박"  value="${host5.roomPay}">
							</c:when>
							<c:otherwise>
				  ...
				  <button type="button" id="plusBtn" class="btn btn-warning btn-sm">추가</button>
