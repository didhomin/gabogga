      ...
      public void setNavigator() {
         ...
         for (int i = startPage; i <= endPage; i++) {
            if (pageNo == i) {
               ...
               tmpNavigator.append("     <li class="+"page-item"+"><a class="+"page-link"+" href='javascript:page(" + i + ");'>"+i+"</a></li>" +"\n");
            }
         }
